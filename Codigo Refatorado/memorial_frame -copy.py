...
class MemorialCalculoFrame(tk.Frame):
    ...
    def _criar_layout_cabecalho(self):
        ...
        self._criar_celula_cabecalho(row2_frame, "Alimentador:", self.campos_dict["Alimentador"], ttk.Combobox, {"values": [""] + opcoes_alimentador}, 10, 17)
        opcoes_motivador = self._get_opcoes_formatadas('motivador')
        ...
        opcoes_telecontrolado = self._get_opcoes_formatadas('telecontrolado')
        self._criar_celula_cabecalho(row3_frame, "Telecontrolado:", self.campos_dict["Telecontrolado"], ttk.Combobox, {"values": opcoes_telecontrolado}, 12, 5)
        ...
        opcoes_manobra = self._get_opcoes_formatadas('manobra_efetiva')
        self._criar_celula_cabecalho(row4_frame, "Manobra Efetiva:", self.campos_dict["Manobra Efetiva"], ttk.Combobox, {"values": opcoes_manobra}, 14, 5)
        opcoes_acessante = self._get_opcoes_formatadas('vinculado_acessante')
        self._criar_celula_cabecalho(row4_frame, "Vinculado a Acessante:", self.campos_dict["Vinculado a Acessante"], ttk.Combobox, {"values": opcoes_acessante}, 19, 5)
