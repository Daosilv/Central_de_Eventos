...
# As importações de módulos locais foram movidas para dentro das funções
...
class App(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.model = None  # O modelo será inicializado depois

        style = ttk.Style()
        style.theme_use('clam')
        
        # Adia a inicialização do banco de dados e a importação de módulos pesados
        # para depois que a janela principal estiver pronta.
    ...
    def setup_database_and_app(self):
        """
        Esta função é chamada uma vez quando o programa está ocioso.
        Ela importa os módulos necessários e cria as tabelas do banco de dados,
        quebrando qualquer ciclo de importação na inicialização.
        """
        # --- INÍCIO DA ALTERAÇÃO ---
        try:
