...
class MemorialCalculoFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Chama o método para fixar a largura do espaçador após a interface ser desenhada
    ...
    def criar_layout_principal(self):
        ...
        # Configuração inicial das colunas como fixas (weight=0)
    ...
    def _set_fixed_spacer_width(self):
        ...
        # Subtrai as larguras das colunas e um valor para paddings/bordas da tela
        spacer_width = screen_width - col1_width - col3_width - 70
        spacer_width = max(1, spacer_width)

        # Configura a coluna 2 para ter uma largura mínima fixa, tornando-a rígida
        self.content_holder_frame.grid_columnconfigure(1, minsize=spacer_width)

    def on_canvas_configure(self, event):
        # Layout fixo: não faz nada para que o conteúdo não se redimensione com a janela.
        pass
