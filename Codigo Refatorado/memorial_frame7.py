...
class MemorialCalculoFrame(tk.Frame):
    ...
    def criar_layout_principal(self):
        ...
        # --- ALTERAÇÃO APLICADA AQUI: Lógica para forçar a largura do container ---
    ...
    # --- ALTERAÇÃO APLICADA AQUI: Nova função para redimensionar o frame dos rascunhos ---
    ...
    def _filtrar_ajustes_recentes(self, *args): self._filtrar_lista(self.busca_ajustes_var, self.lista_ajustes_completa, self.listbox_local)
