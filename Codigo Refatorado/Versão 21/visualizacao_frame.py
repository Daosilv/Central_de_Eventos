...
class VisualizacaoFrame(tk.Frame):
    ...
    def criar_widgets(self):
        # --- Estilo da Treeview ---
        style = ttk.Style()
        style.configure("Treeview", font=FONTE_PADRAO, rowheight=30) # Ajusta a fonte e altura da linha
        style.configure("Treeview.Heading", font=FONTE_PADRAO) # Ajusta a fonte do cabeçalho
