...
class MemorialCalculoFrame(tk.Frame):
    ...
    def _criar_layout_cabecalho(self):
        ...
        self._criar_celula_cabecalho(row1_frame, "Autor:", self.campos_dict["Autor"], tk.Entry, {}, 4, 51)
        ...
        self._criar_celula_cabecalho(row2_frame, "Endereço:", self.campos_dict["Endereço"], tk.Entry, {}, 8, 45)
        ...
        self._criar_celula_cabecalho(row3_frame, "Siom:", self.campos_dict["Siom"], tk.Entry, {}, 4, 5)
        ...
        self.frame_acessante = self._criar_celula_cabecalho(row4_frame, "Eqpto Acessante:", self.campos_dict["Eqpto Acessante"], tk.Entry, {}, 14, 10)

    def _criar_celula_cabecalho(self, parent, label_text, var, widget_class, widget_options, label_width, entry_width, categoria_db=None, tipo_lista=None, nome_widget=None):
    ...
    def reconstruir_lista_ajustes(self, *args):
        ...
        for i, item in enumerate(filtrados):
            ...
            # Fallback para o campo 'data' se 'data_registro' falhar
