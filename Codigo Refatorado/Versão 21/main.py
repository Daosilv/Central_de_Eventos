...
class App(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        # Tenta carregar o logo para exibição, mas não para definir o tamanho
        try:
            ...
            # A falha em carregar o logo não impede a execução, um fallback de texto será usado
            pass
        ...
        # Define a resolução fixa para a janela
        ...
        self.frames = {}
        # Passa a imagem (ou None) para o MenuFrame
    ...
    def export_to_excel(self, view, map_id):
        ...
        def show_wait_window(parent, message):
        ...
        try:
            loading_win = show_wait_window(view.parent_window, "Abrindo planilha padrão em segundo plano...")
            workbook = openpyxl.load_workbook(template_path, keep_vba=True)
            loading_win.destroy()
            
            wait_win = show_wait_window(view.parent_window, "Aguardando 5 segundos...")
            time.sleep(5)
            wait_win.destroy()
            ...
            wait_win = show_wait_window(view.parent_window, "Preenchendo Condição... Aguardando 10 segundos.")
            time.sleep(10)
            wait_win.destroy()
            ...
            wait_win = show_wait_window(view.parent_window, "Preenchendo Cabeçalho... Aguardando 10 segundos.")
            time.sleep(10)
            wait_win.destroy()
    ...
    # --- MÉTODO ADICIONADO PARA CORRIGIR O CLIQUE NO HISTÓRICO DE AJUSTES ---
...
class MenuFrame(tk.Frame):
    def __init__(self, parent, controller, logo=None):
        ...
        # Frame do título com a cor de fundo cinza original
        ...
        if logo:
            ...
            # Fallback para texto caso o logo não tenha sido carregado
