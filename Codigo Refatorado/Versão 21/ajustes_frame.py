...
class AjustesFrame(tk.Frame):
    ...
    def criar_layout(self):
        ...
        main_container.grid_rowconfigure(1, weight=1) # Alterado de 2 para 1
        ...
        # O cabeçalho foi removido daqui para ser adicionado dentro da área de rolagem
        canvas_frame = tk.Frame(main_container)
        canvas_frame.grid(row=1, column=0, sticky='nsew') # Alterado de 2 para 1
        ...
        # Este é o frame que conterá o cabeçalho e os itens, e que será rolável
    ...
    def _filtrar_e_recarregar_pendentes(self, *args):
        ...
        # Cria o cabeçalho DENTRO do frame rolável para garantir o alinhamento
    ...
    def _abrir_janela_detalhes(self, eqpto):
        # Busca o ID do registro mais recente para o equipamento clicado
        ...
        if id_result and id_result.get('id'):
            ...
            # Abre a janela de detalhes (a mesma do módulo de visualização)
    ...
    def _filtrar_e_recarregar_historico(self, *args):
        ...
        if historico_filtrado:
            ...
            for item in historico_filtrado:
                ...
                row.grid_columnconfigure(0, weight=1) # Faz a coluna do eqpto expandir
    ...
    def _criar_linha_equipamento(self, parent, dados, row_index):
        ...
        # A linha de dados começa em 2, pois as linhas 0 e 1 são para o cabeçalho
