...
class MemorialCalculoFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.campos_dict = { "Autor": tk.StringVar(), "Eqpto": tk.StringVar(), "Malha": tk.StringVar(), "Condição": tk.StringVar(), "Motivador": tk.StringVar(), "Alimentador": tk.StringVar(), "NS": tk.StringVar(), "Siom": tk.StringVar(), "Data": tk.StringVar(value=datetime.now().strftime('%d/%m/%Y')), "Coord": tk.StringVar(), "Endereço": tk.StringVar(), "Mídia": tk.StringVar(), "Fabricante": tk.StringVar(), "Modelo": tk.StringVar(), "Comando": tk.StringVar(), "Telecontrolado": tk.StringVar(value="sim"), "Bypass_1": tk.StringVar(), "Bypass_2": tk.StringVar(),
                            "tensao_kv": tk.StringVar(), "corrente_fase_a": tk.StringVar(), "corrente_fase_b": tk.StringVar(), "corrente_fase_c": tk.StringVar(), "vinculado_acessante": tk.StringVar(value="não")}
    ...
    def get_db_columns():
        ...
        colunas_dict = { "Autor": "", "Eqpto": "", "Malha": "", "Condição": "", "Motivador": "", "Alimentador": "", "NS": "", "Siom": "", "Data": "", "Coord": "", "Endereço": "", "Mídia": "", "Fabricante": "", "Modelo": "", "Comando": "", "Telecontrolado": "", "Bypass_1": "", "Bypass_2": "", "tensao_kv": "", "corrente_fase_a": "", "corrente_fase_b": "", "corrente_fase_c": "", "vinculado_acessante": "" }
    ...
    def criar_layout_formulario(self):
        ...
        # Inserção da tabela Tensão e Corrente
        self._criar_tabela_tensao_corrente(self.main_form_frame)

        # Checkbox 'Manobra Efetiva'
    ...
    def _criar_tabela_tensao_corrente(self, parent):
        ...
        frame_tabela.pack(pady=(10, 20), anchor='center')
        frame_tabela.grid_columnconfigure(0, minsize=180)
        frame_tabela.grid_columnconfigure(1, minsize=120)
    ...
    def get_form_data(self):
        ...
        data['manobra_efetiva'] = self.manobra_efetiva_var.get()
        return data
    ...
    def preencher_formulario(self, dados_dict):
        ...
        self.manobra_efetiva_var.set(dados_dict.get('manobra_efetiva', False))
    ...
    def limpar_formulario(self):
        ...
        self.campos_dict["vinculado_acessante"].set("não")
