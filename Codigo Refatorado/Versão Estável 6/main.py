...
# Os imports dos frames foram removidos daqui para serem carregados sob demanda

FONTE_TITULO = ("Helvetica", 22, "bold")
FONTE_BOTAO_MENU = ("Helvetica", 14)
CAMINHO_BD = r'C:\BD_APP_Cemig\Primeiro_banco.db'

def get_memorial_db_columns():
    """Define e retorna a lista de colunas para o banco de dados do memorial.
    Esta função foi movida de MemorialCalculoFrame para permitir o carregamento tardio."""
...
class App(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        colunas_memorial = get_memorial_db_columns()
    ...
    def gerar_documento_excel(self, view):
        ...
        try:
            ...
            messagebox.showerror("Erro de Arquivo", f"O template da planilha não foi encontrado em:\n{template_path}", parent=view.parent_window)
