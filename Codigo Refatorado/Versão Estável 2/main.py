...
class App(tk.Tk):
    ...
    def atualizar_listas_memorial(self, view):
        # ATUALIZADO para buscar a lista com status
    ...
    # --- MÉTODOS DE OBSERVAÇÃO ATUALIZADOS ---
    def carregar_observacoes(self, eqpto):
        """Carrega o histórico de observações para um equipamento."""
        return self.model.get_observations(eqpto)

    def adicionar_observacao(self, eqpto, autor, texto):
        """Adiciona uma nova observação ao histórico."""
