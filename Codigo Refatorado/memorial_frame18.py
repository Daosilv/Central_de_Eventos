...
class MemorialCalculoFrame(tk.Frame):
    ...
    def _criar_novas_tabelas_parametros(self, parent):
        ...
        for i, label in enumerate(labels_coord[:4]):
            tk.Label(coluna_esquerda, text=label, font=FONTE_PADRAO, relief="solid", bd=1, anchor='w', width=13).grid(row=i+2, column=0, sticky='nsew')
            tk.Entry(coluna_esquerda, textvariable=self.campos_dict[vars_consumo[i]], font=FONTE_PADRAO, justify='center', relief='solid', bd=1, width=6).grid(row=i+2, column=1, sticky='nsew')
            tk.Entry(coluna_esquerda, textvariable=self.campos_dict[vars_injecao[i]], font=FONTE_PADRAO, justify='center', relief='solid', bd=1, width=6).grid(row=i+2, column=2, sticky='nsew')
        ...
        tk.Label(coluna_esquerda, text="", font=FONTE_PADRAO, relief="solid", bd=1).grid(row=9, column=0, sticky='nsew')
        tk.Label(coluna_esquerda, text="Lado 1\nA montante", font=FONTE_PADRAO, relief="solid", bd=1, wraplength=70, justify="center").grid(row=9, column=1, sticky='nsew')
        tk.Label(coluna_esquerda, text="Lado 2", font=FONTE_PADRAO, relief="solid", bd=1).grid(row=9, column=2, sticky='nsew')
        ...
        for i, label in enumerate(labels_montante):
            row_num = i + 10
            tk.Label(coluna_esquerda, text=label, font=FONTE_PADRAO, relief="solid", bd=1, anchor='w', width=13).grid(row=row_num, column=0, sticky='nsew')
            tk.Entry(coluna_esquerda, textvariable=self.campos_dict[f"{vars_montante[i]}_l1"], font=FONTE_PADRAO, justify='center', relief='solid', bd=1, width=6).grid(row=row_num, column=1, sticky='nsew')
            tk.Entry(coluna_esquerda, textvariable=self.campos_dict[f"{vars_montante[i]}_l2"], font=FONTE_PADRAO, justify='center', relief='solid', bd=1, width=6).grid(row=row_num, column=2, sticky='nsew')
        ...
        for i in range(16): coluna_esquerda.grid_rowconfigure(i, minsize=30)
