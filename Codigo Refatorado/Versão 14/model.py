...
class DatabaseModel:
    ...
    def _migrate_mappings_table(self):
        ...
        if 'mapa_id' not in existing_columns:
            ...
            # Removendo a constraint UNIQUE antiga se existir
            # (SQLite não tem um comando fácil para remover UNIQUE, então a recriação da tabela seria o ideal,
            # mas vamos assumir que o erro de violação de constraint guiará o desenvolvedor se necessário)
    ...
    # MODIFICAÇÃO APLICADA AQUI: A função agora atualiza também o campo_app
