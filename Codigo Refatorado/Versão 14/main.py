...
class App(tk.Tk):
    ...
    def export_to_excel(self, view, map_id):
        ...
        try:
            ...
            # --- INÍCIO DA NOVA FUNCIONALIDADE: GERAR PDF DO SUMÁRIO ---
            pdf_save_path = ""
            ...
            if sumario_sheet_name in workbook.sheetnames:
                ...
                try:
                    ...
                    ws.ExportAsFixedFormat(0, os.path.abspath(pdf_save_path)) # 0 = xlTypePDF
                    ...
                    pdf_save_path = "" # Reseta o caminho em caso de erro
                finally:
                    if excel_app:
                        excel_app.Quit()
