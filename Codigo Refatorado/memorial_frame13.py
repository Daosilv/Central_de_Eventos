...
class MemorialCalculoFrame(tk.Frame):
    ...
    def criar_layout_principal(self):
        ...
        # --- ALTERAÇÃO DE LAYOUT PRINCIPAL ---
        # Configura as colunas
        self.content_holder_frame.grid_columnconfigure(0, weight=0)
        self.content_holder_frame.grid_columnconfigure(1, weight=1) # Coluna espaçadora
        self.content_holder_frame.grid_columnconfigure(2, weight=0)
        
        # Configura as linhas
        self.content_holder_frame.grid_rowconfigure(0, weight=0) # Linha do cabeçalho
        self.content_holder_frame.grid_rowconfigure(1, weight=1) # Linha do conteúdo principal

        # Cria o frame do cabeçalho e posiciona na linha 0, abrangendo as colunas 1 e 2
        ...
        # O frame principal agora vai na linha 1
        ...
        # A sidebar agora abrange 2 linhas para se alinhar ao cabeçalho e ao conteúdo
    ...
    def _criar_layout_cabecalho(self):
        # Este método agora cria o cabeçalho dentro do self.header_frame
    ...
    def criar_layout_formulario(self):
        # Este método agora cria o conteúdo ABAIXO do cabeçalho
