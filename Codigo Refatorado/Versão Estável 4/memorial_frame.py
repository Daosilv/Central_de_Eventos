...
class MemorialCalculoFrame(tk.Frame):
    ...
    # --- CORREÇÃO: Lógica de clique na lista suspensa aprimorada ---
    def open_dropdown_on_click(self, event):
        """
        Agenda a abertura da lista suspensa para ocorrer um instante após o clique,
        permitindo que o Tkinter processe primeiro o fechamento de outras listas.
        """
        widget = event.widget
