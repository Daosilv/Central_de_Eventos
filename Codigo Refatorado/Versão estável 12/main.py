...
class App(tk.Tk):
    ...
    def export_to_excel(self, view, map_id):
        ...
        if not mapeamentos_db:
            messagebox.showerror("Erro", "Nenhum mapeamento para o Excel foi encontrado para o mapa selecionado.", parent=view.parent_window)
            return
    ...
    # --- MÉTODOS PARA GERENCIAR MAPAS DE MAPEAMENTO ---
