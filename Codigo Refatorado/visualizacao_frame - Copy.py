...
class DetalhesWindow(tk.Toplevel):
    def __init__(self, parent, controller, id_ficha):
        ...
        # CORREÇÃO 2: Habilita o redimensionamento, o que restaura o botão maximizar.
        self.resizable(True, True)
        # A linha self.transient(parent) foi removida, pois ela impedia o botão de maximizar de aparecer.
        ...
        # CORREÇÃO 1: Adiciona os bindings para a rolagem do mouse funcionar no frame principal.
    ...
    # --- Métodos para a Correção 1 (Scroll do Mouse) ---
    ...
    # --- Fim dos métodos para a Correção 1 ---
    ...
    def criar_layout_visualizacao(self):
        ...
        # --- Bloco de Tabelas Replicado (Condicional) ---
