...
class AjustesFrame(tk.Frame):
    ...
    def carregar_equipamentos_pendentes(self):
        ...
        self.items_frame.columnconfigure(0, weight=0)
        self.items_frame.columnconfigure(1, weight=3)
        self.items_frame.columnconfigure(2, weight=5)
        self.items_frame.columnconfigure(3, weight=3)
        self.items_frame.columnconfigure(4, weight=3)
        self.items_frame.columnconfigure(5, weight=4)
        self.items_frame.columnconfigure(6, weight=0)

        # --- BLOCO DE CÓDIGO DO CABEÇALHO REMOVIDO DAQUI ---
        ...
        try:
            with sqlite3.connect(caminho_bd_ativo) as conexao:
                ...
                # --- MUDANÇA: O loop agora começa do índice 0 ---
