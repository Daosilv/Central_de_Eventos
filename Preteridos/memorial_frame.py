...
class MemorialCalculoFrame(tk.Frame):
    ...
    def criar_layout_formulario(self):
        ...
        col_widths = [90, 70, 85, 120, 120, 70, 85, 120, 120]
        for c, minsize in enumerate(col_widths): frame_tabela_header.grid_columnconfigure(c, minsize=minsize)
        ...
        # --- Tabelas de Grupo ---
        for i in range(1, 4):
            tabela_frame, _, group_vars = self.criar_tabela_grupo(wrap_tabelas, f"  Grupo {i}  ")
    ...
    def criar_tabela_grupo(self, parent, group_name):
        ...
        col_widths = [90, 70, 85, 120, 120, 70, 85, 120, 120]
        for c, minsize in enumerate(col_widths): frame_tabela.grid_columnconfigure(c, minsize=minsize)
