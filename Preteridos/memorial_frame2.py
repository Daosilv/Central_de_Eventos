...
# O diretório de backup não é mais necessário para a nova funcionalidade
...
class MemorialCalculoFrame(tk.Frame):
    ...
    def criar_layout_principal(self):
        ...
        # --- MODIFICADO: Rótulo e lista de Rascunhos ---
    ...
    def _salvar_dados(self, tabela):
        """Função auxiliar para salvar dados em uma tabela específica ('cadastros' ou 'rascunhos')."""
    ...
    def salvar_e_enviar(self):
        ...
        if self._salvar_dados('cadastros'):
            ...
            # Remove rascunho para o mesmo equipamento, se existir
            try:
                with sqlite3.connect(caminho_bd_ativo) as conexao:
                    cursor = conexao.cursor()
    ...
    def abrir_janela_busca(self):
        ...
        def executar_busca():
            ...
            try:
                with sqlite3.connect(caminho_bd_ativo) as conexao:
                    cursor = conexao.cursor()
                    # Busca sempre na tabela principal 'cadastros'
