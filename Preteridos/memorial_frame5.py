...
class MemorialCalculoFrame(tk.Frame):
    ...
    def criar_layout_principal(self):
        ...
        # --- MODIFICADO: Seção Ajustes Recentes com Borda ---
        ...
        # --- MODIFICADO: Seção Concluídos com Borda ---
    ...
    def criar_layout_formulario(self):
        # Esta função não foi alterada, o código é omitido por brevidade
        ...
        # --- Linhas do Cabeçalho (código omitido) ---
        ...
        # --- Tabelas e Botões (código omitido) ---
    ...
    def _toggle_selecionar_tudo_rascunhos(self):
        """Marca ou desmarca todos os checkboxes de rascunhos."""
    ...
    def deletar_rascunho_individual(self, eqpto_para_deletar):
        """Deleta um único rascunho especificado pelo nome."""
    ...
    def deletar_rascunhos_selecionados(self):
        """Deleta todos os rascunhos que estão com o checkbox marcado."""
    ...
    def reconstruir_lista_rascunhos(self, *args):
        """Busca, filtra e recria a lista de rascunhos com widgets customizados."""
        ...
        self.rascunhos_canvas.yview_moveto(0) # Volta a scrollbar para o topo

    def atualizar_lista_concluidos(self):
        """Atualiza a lista de concluídos (atualmente vazia)."""
    ...
    def carregar_rascunho_pelo_nome(self, eqpto):
        """Carrega o rascunho mais recente a partir do nome do equipamento."""
        try:
            with sqlite3.connect(caminho_bd_ativo) as conexao:
                cursor = conexao.cursor()
    ...
    def abrir_janela_busca(self):
        ...
        # ... (restante da função omitido por brevidade)
